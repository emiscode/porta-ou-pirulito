...
export default function Lollipop({ foiPegado }: LollipopProps) {
  ...
  return (
    <div className="relative">
      {/* Palito */}
      <div className="w-1 h-12 sm:h-16 bg-amber-700 mx-auto" />
      
      {/* Pirulito */}
      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-pink-400 via-red-400 to-pink-500 rounded-full border-4 border-white shadow-lg relative">
